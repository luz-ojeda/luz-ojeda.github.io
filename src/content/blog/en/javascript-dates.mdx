...
While migrating my personal website to Astro I added a tiny JavaScript function to calculate my age in the about page. Just because I wanted to, it's a relatively free world and was something I wanted to do while using Jekyll but for some reason or another found it too tedious to mix JavaScript and markdown files.
...
The only use case I could think is for copying dates:

...
While migrating my personal website to Astro I added a tiny javascript function to calculate my age in the about page, just because I wanted it's a, relative, free world and is something I wanted to do when I was using Jekyll but for some reason or another found it too tedious to mix JavaScript and markdown files.

While playing with the `Date` object I realized i never got the real hang of how dates work in javascript. Always had to google more than I prefer to admit and read the docs almost from scratch every time

So enough was enough so I wrote this for my better understanding and in the hope of helping others that struggled as I did with dates.

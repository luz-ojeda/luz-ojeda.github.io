...
#### So what if I want to add X days/months?
```
const now = new Date();
...
Can't imagine a scenario where someone would want to do this but the result is the same as with subtraction. Timestamps are multiplied/divided.

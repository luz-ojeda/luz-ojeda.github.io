	...
	return (
		<div>
			...
			<div>
				...
				{invalidDate && (
					<p className="error">La fecha ingresada no es válida</p>
				)}
			</div>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							diferencia entre la zona horaria UTC y la
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							formato simplificado basado en{" "}
							<a href="https://es.wikipedia.org/wiki/ISO_8601">
								ISO 8601
							</a>
						</td>
					</tr>
					<tr>
						...
						<td>
							representación vinculada al idioma de la
							fecha en la zona horaria local
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							porción de tiempo de la fecha interpretada
